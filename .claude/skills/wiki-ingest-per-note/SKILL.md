...
- **`.vtt` transcripts**: run `python3 scripts/system/convert-vtt-to-md.py --input-dir raw/transcripts` (or pass a single file path). The script does the move, companion, and callout for you.
- **`.eml` emails**: run `python3 scripts/system/convert-eml-to-md.py --input-dir raw/emails` (or a single file path).
- **`.html` emails**: run `python3 scripts/system/convert-html-to-md.py --input-dir raw/emails` (or a single file path).
