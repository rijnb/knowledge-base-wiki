...
HELP_LINES = [
    ...
    "  e              Open source file in default editor",
    "",
    "ORPHAN ATTACHMENT ACTIONS  (when an orphan attachment is selected)",
    "  d              Delete the attachment file from disk",
    "  e              Open the file in its default application",
    "                 (no 'keep' — leave it unhandled to keep it)",
    "",
